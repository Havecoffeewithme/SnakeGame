...
const boardBackground = "nightforest";
...
function createFood(){
    function randomFood(min,max){
        const randNum = Math.round((Math.round() * (max - min) + min) / unitSize) * unitSize;
        return randNum;
    }
...
function displayGameOver(){
    ...
    ctx.filltext("GAME OVER!", gameWidth/2.2 , gameHeight / 2.2);
    running = false;
};
function resetGame(){
    score = 0;
